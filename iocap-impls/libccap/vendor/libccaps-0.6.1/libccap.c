...
LIBCCAP_INTERNAL_FUNC_PREFIX void libccap_simple_panic(const char* msg) {
...
LIBCCAP_INTERNAL_FUNC_PREFIX CCapResult libccap_check_cap_perms_chain(uint8_t chain) {
    if (chain >= 0b1111) {
